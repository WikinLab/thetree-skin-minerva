 ...
 * imported Vector, Popups, and Cite JavaScript modules.
 *
...
export function makeTheTreeMediaWikiConfig(runtimeData = {}) {
  return Object.freeze({
    ...
    wgPopupsGateway: runtimeData.summaryEndpoint ? 'theTreeSummary' : 'none',
    wgPopupsRestGatewayEndpoint: runtimeData.summaryEndpoint,
    wgPopupsTextExtractsIntroOnly: runtimeData.textExtractsIntroOnly !== false,
    wgPopupsVirtualPageViews: false,
    wgCiteReferencePreviewsActive: runtimeData.enabled === true,
    wgMFMode: false
  });
}
...
export const theTreeMediaWikiRuntimeInternals = Object.freeze({
  escapeRegExp,
  escapeHtml,
  makeConfigMap,
  parseNamespaceId,
