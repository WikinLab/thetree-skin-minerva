...
export const theTreePopupsSettingsAdapterInternals = Object.freeze({
  THE_TREE_SETTINGS_STORAGE_KEY,
  PREVIEW_TYPES,
  PREVIEW_TYPE_STORAGE_KEYS,
  LEGACY_DISABLED_STORAGE_KEYS,
  coercePreviewTypeEnabled
});
