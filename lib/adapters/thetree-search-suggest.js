 ...
 *
 * Vector keeps ownership of LegacySearchBox.mustache. This adapter only fills
 * the ResourceLoader searchSuggest slot with host results and router actions.
 */
...
export function createTheTreeSearchSuggestRuntime(options = {}) {
  ...
  function init() {
    ...
    searchRoot = documentRoot.getElementById('simpleSearch');
