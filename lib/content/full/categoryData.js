...
import { makeDocumentActionTarget } from '../../legacyTheTreeAdapter';
import {
  LEGACY_CATEGORY_SOURCE_PATH,
  getLegacyStructuredCategories
} from '../../legacyCategoryContract';

export const CATEGORY_SLOT_OWNERSHIP_PHASE = 'v213';
...
export function makeLegacyCategoryData(context = {}) {
  ...
  return {
    phase: CATEGORY_SLOT_OWNERSHIP_PHASE,
    source: source.id,
