...
export const DOCUMENT_ACTION_MAP = defineFeatureMap([
  ...
  },
  {
    ...
    target: {
      system: 'mediawiki-vector-legacy', feature: 'watchstar', portletKey: 'data-views',
...
export const PERSONAL_TOOL_MAP = defineFeatureMap([
  ...
  },
  {
    ...
    target: {
      system: 'mediawiki-vector-legacy', feature: 'anonymous-talk', portletKey: 'data-user-menu',
  ...
  },
  {
    ...
    target: {
      system: 'mediawiki-vector-legacy', feature: 'anonymous-contributions', portletKey: 'data-user-menu',
  ...
  },
  {
    ...
    target: {
      system: 'mediawiki-vector-legacy', feature: 'notifications', portletKey: 'data-user-menu',
  ...
  },
  {
    ...
    target: {
      system: 'mediawiki-vector-legacy', feature: 'user-talk', portletKey: 'data-user-menu',
  ...
  },
  {
    ...
    target: {
      system: 'mediawiki-vector-legacy', feature: 'local-account-management', portletKey: 'data-user-menu',
...
export const SIDEBAR_TOOLBOX_MAP = defineFeatureMap([
  ...
  },
  {
    ...
    target: { system: 'mediawiki-vector-legacy', feature: 'special-lonelycategories', portletKey: 'array-portlets-rest', portletId: 'p-tb', itemId: 't-orphanedcategories', labelFallback: '고립된 분류' },
    transform: { kind: 'static-route' }, equivalence: FEATURE_EQUIVALENCE.ANALOG, loss: []
  },
  {
  ...
  },
  {
    ...
    target: { system: 'mediawiki-vector-legacy', feature: 'special-randompage-list', portletKey: 'array-portlets-rest', portletId: 'p-tb', itemId: 't-randompage-list', labelFallback: '임의 문서 목록' },
  ...
  },
  {
    ...
    target: { system: 'mediawiki-vector-legacy', feature: 'relevant-user-contributions', portletKey: 'array-portlets-rest', portletId: 'p-tb', itemId: 't-contributions', labelFallback: '사용자 기여' },
