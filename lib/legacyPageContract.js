...
import { getLegacyHostViewMapping } from './legacySpecialPageContract';
...
export function makeLegacyPageContract(context = {}) {
  ...
  const mapping = getLegacyHostViewMapping(viewName, contentName);
...
export function getLegacyPageContract(context = {}) {
  return context.pageContract || makeLegacyPageContract(context);
}
