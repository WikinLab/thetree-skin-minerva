...
import { makeFooterInfoData } from './legacyFooterData';
...
export function makeSkinLegacyData(context = {}) {
  ...
  return {
    ...
    'data-portlets': {
      ...navigationPortlets,
      'data-footer-info': makeFooterInfoData(page, pageContract),
      'data-footer-places': makeFooterPlacesData(context),
      'data-footer-icons': makeLegacyFooterIconData(),
