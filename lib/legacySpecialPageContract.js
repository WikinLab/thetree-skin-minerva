...
import { FEATURE_EQUIVALENCE } from './legacyHostAdapterPolicy.js';

export const SPECIAL_PAGE_CONTRACT_BASELINE = 'v355-template-literal-line-terminator-closure';
export const SPECIAL_PAGE_MAPPING_PHASE = 'v355-template-literal-safe-host-source-role-projection';

export const THETREE_HOST_LOCK = Object.freeze({
  frontendRepository: 'wjdgustn/thetree-frontend',
  frontendRef: 'master',
  frontendCommit: '636fa9ade48a47f12f047ec1aa58f220992077ea',
  frontendCheckout: 'host-thetree-frontend',
  frontendSourceRoot: 'src/views/contents',
  frontendBootstrapPaths: Object.freeze(['src/views/contents/']),
  backendRepository: 'wjdgustn/thetree',
  backendRef: 'master',
  backendCommit: '698e2122bafdd02e6e65170c1d55b319336a7e72',
  backendCheckout: 'host-thetree',
  backendSourceRoots: Object.freeze(['routes']),
  backendBootstrapPaths: Object.freeze(['routes/']),
  contract: 'lib/legacySpecialPageContract.js',
  validator: 'tools/host-view-contract-engine.mjs'
});
...
export function validateLegacyHostViewContract() {
  ...
  if (errors.length) throw new Error(`Invalid v355 host view contract:\n- ${errors.join('\n- ')}`);
  return true;
}
